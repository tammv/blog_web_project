    ...
    <div className="block w-auto mx-72">
      <div className="mt-10 mb-6">
        <div className="relative rounded z-10 p-16 h-56 bg-slate-50 border">
          ...
          <div className="px-4 text-light-2">
            <p className="flex flex-row gap-2"><img className="w-6 h-6 rounded-full" src={quizzesStores.userId.profilePicture} alt="Avatar User Create Quizz" /> {quizzesStores.userId.username}</p>
          </div>
        </div>
      </div>
